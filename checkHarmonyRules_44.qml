...
MuseScore {
      title: "Check Harmony Rules"
      categoryCode: "composing-arranging-tools"
      menuPath: "Plugins.Proof Reading.Check Harmony Rules"
      description: "Based on the textbook 'First Year Harmony' by William Lovelock and aiming at providing the functionality of the plugin harmonyRules by Yvonne Cliff for MuseScore v1.x"
      version: "0.2"
      requiresScore: true
