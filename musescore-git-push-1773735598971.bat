...
set "SCORE=Chiisana Koi No Uta"
set "SCOREFILE=%SCORE%.mscz"
set "DIFFLOG=C:\Users\Winson Wang\OneDrive\Documents\MuseScore4\Scores\Chiisana Koi No Uta\Chiisana Koi No Uta_diff.log.txt"
